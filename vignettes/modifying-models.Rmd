...
- Create a simulation data frame or list and verify these simulations run with the original cod model using the function `run_ss3sim` or `ss3sim_base`, respectively.
