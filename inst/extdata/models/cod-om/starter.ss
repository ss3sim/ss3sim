...
0 #_last_estimation_phase:  turn off estimation for parameters entering after this phase
#
0 #_MCMCburn
-1 #_MCMCthin
0 # jitter_fraction:  jitter within parameter bounds
-1 #_minyr_sdreport:  min year for sdreport outputs (-1 for styr); #_-1
-1 #_maxyr_sdreport:  max year for sdreport outputs (-1 for endyr+1; -2 for endyr+Nforecastyrs); #_101
