...
% TODO add section demonstrating parallel runs (if not, strip it from the
% paper)
...
not used elsewhere (i.e. anything but D, E, F, or R) and include the line
...
expand_scenarios(list(D = 1:2, E = 100:101, F = 0, M = 0, R = 0), species = "cod")
