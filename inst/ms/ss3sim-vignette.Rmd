...
```{r plot-deterministic, fig.height=4, fig.width=7, fig.cap="Boxplot of relative error for SSB MSY. We see relatively little bias."}
...
```{r plot-sto-ts, fig.height=4, fig.width=7, fig.cap="Time series of relative error in spawning stock biomass."}
