...
\begin{verbatim}
fleets;  2
years;   list(1974:2012)
sds_obs; list(0.1)
\end{verbatim}

\noindent
\texttt{fleets} refers to the fleet type we want to sample from. \texttt{2} in
...
estimator) estimates of parameters; it is intended to only be run for one
