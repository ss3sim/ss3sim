...
can be checked by running \texttt{ss3_24o_safe -nohess} to make sure the
...
\begin{enumerate}
\item Delete the starter.ss file and rename starter.ss_new to
  starter.ss. Modify this new file.
\item
