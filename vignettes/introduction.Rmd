...
Also, if you are working with a development version of `ss3sim` i.e.,
`devtools::load_all()` or `devtools::install_()`
and you are on a Windows machine, you may not be able to run in parallel 
without building the package, restarting `R`, and installing the local build. 
