...
\citep{ono2013} and \citep{johnson2013}.
...
run_ss3sim(iterations = 1, scenarios =
  ...
  em_model_dir = em, user_recdevs = recdevs_det)
@
...
You can look at all the case files in the package folder \texttt{/inst/extdata/eg-cases/}. 
...
You can specify any parameter defined in your SS model as time varying
