...
#'  should be named \code{agecomp}. A suggested (default) case letter is
#'  \code{D} for data.
#'
...
#' @template dat_list
#' @template Nsamp
#' @param keep_conditional A logical if conditional age-at-length data should
#'    be kept or removed entirely from the \code{.dat} file.
#'    \code{sample_agecomp} only works on the age composition data and not on
#'    the conditional age-at-length data. To sample the conditional data set
#'    \code{keep_conditional} to \code{TRUE} and use
