...
ss3sim also relies on the R package [r4ss](https://github.com/r4ss/r4ss) to read and write SS files. r4ss is available on [CRAN](https://cran.r-project.org/package=r4ss) and [github](https://github.com/r4ss/r4ss). The master branch of ss3sim uses the CRAN version of r4ss, while other branches use the development version of r4ss. Feel free to install r4ss directly via
```{r, r4ss, eval=FALSE}
remotes::install_github("r4ss/r4ss@development",
  dependencies = TRUE, upgrade = FALSE, build_vignettes = TRUE)`
```
Though, installing ss3sim will do the previous for you if you don't already have r4ss available in your R library.
