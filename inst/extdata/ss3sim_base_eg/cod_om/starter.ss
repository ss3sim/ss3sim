...
0 # Include prior_like for non-estimated parameters (0,1) ########## REMOVE PRIORS IN CTL ##################
1 # Use Soft Boundaries to aid convergence (0,1) (recommended)
3 # Number of datafiles to produce: 1st is input, 2nd is estimates, 3rd and higher are bootstrap
0 # Turn off estimation for parameters entering after this phase - #### NECESSARY TO SET TO 0 FOR OPERATING MODEL
...
4 # F_report_units: 0=skip; 1=exploitation(Bio); 2=exploitation(Num); 3=sum(Frates); 4=true F for range of ages  #I changed this value 4*
1 23 #_min and max age over which average F will be calculated						    
0 # F_report_basis: 0=raw; 1=F/Fspr; 2=F/Fmsy ; 3=F/Fbtgt						# It was 1
