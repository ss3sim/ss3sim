...
TODO also make observation error on index deterministic and cut out multiple D
cases here. Just E100 and E101 and D100 (with sd on the observation error of
0.001).
