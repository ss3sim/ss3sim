...
10 # Turn off estimation for parameters entering after this phase - #### NECESSARY TO SET TO 0 FOR OPERATING MODEL
...
2 13 #_min and max age over which average F will be calculated						    
