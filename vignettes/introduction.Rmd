...
---------------              --------------        -----------
`change_f()`                 `F`                   Fishing mortality
`change_r()`                 `R`                   Retrospective years
`change_e()`                 `E`                   Estimation                 
`sample_index()`             `index`               Index data             
`sample_lcomp()`             `lcomp`               Length composition data             
`sample_agecomp()`           `agecomp`             Age composition data
`change_tv()`                anything, see below   Time-varying variables
