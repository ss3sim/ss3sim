...
and are multiplied by sigma R and bias adjusted within the package.
If you specify your own recruitment deviations,
the deviations are used exactly as specified,
and it is up to you to bias correct them
by subtracting half the recruitment variance.
